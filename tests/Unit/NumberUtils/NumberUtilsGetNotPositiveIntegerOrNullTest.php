...
class NumberUtilsGetNotPositiveIntegerOrNullTest extends NumberUtilsTest
{
    /**
    ...
    {
        $this->assertEquals($expected, $this->numberUtils->getNotPositiveIntegerOrNull($number));
    }
